...
#define NI_H
   ...
   *  File Name: ni.h
   *
   *  Purpose: Defines packet formats, constants, and endian functions. 
   *
   */
...
#define INFINITY 999 /* Cost to an unreacheable destination router */
...
/* The following endian functions are implemented in endian.c */
