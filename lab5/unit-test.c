  /*
   *  Thank to Prof. Rao for this file.
   *
   *  File Name: unit-test.c
   *
   *  Purpose: Unit test cases to test the functions in routingtable.c 
   *
   */
...
//Testing Forced Update Rule
    ...
    TestForcedUpd();
    printf("Test Case 4: PASS: Forced update rule\n");

//Testing Split Horizon Rule

    TestSplitHorizon();
    printf("Test Case 5: PASS: Split horizon rule\n");
